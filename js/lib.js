...
$(document).ready(function(){
    ...
    $(".side ul li").hover(function(){
        $(this).find(".sidebox").stop().animate({"width":"175px"},200).css({"background":"#29abe2","padding-left":"17px"})    
    },function(){
        $(this).find(".sidebox").stop().animate({"width":"50px"},200).css({"background":"#29abe2","padding-left":"0"})   
    });
      
	
		$(".side ul li").mouseleave(function(){
	  //$("p").css("background-color","#E9E9E4");
	   $(this).find(".sidebox").stop().animate({"width":"50px"},50).css({"background":"#000022"})  
	  console.log("11")
	});
